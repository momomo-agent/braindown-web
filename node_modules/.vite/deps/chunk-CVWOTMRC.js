...
var Inspector = (_a2 = class {
  constructor(container, clock, meta) {
    ...
    __privateAdd(this, _injectedSlices, /* @__PURE__ */ new Set());
    __privateAdd(this, _consumedSlices, /* @__PURE__ */ new Set());
    __privateAdd(this, _recordedTimers, /* @__PURE__ */ new Map());
    __privateAdd(this, _waitTimers, /* @__PURE__ */ new Map());
    __privateAdd(this, _getSlice, (sliceType) => {
      return __privateGet(this, _container).get(sliceType).get();
    });
    __privateAdd(this, _getTimer, (timerType) => {
...
var Timer = (_a4 = class {
  constructor(clock, type) {
    ...
    __privateAdd(this, _status, "pending");
    ...
    __privateAdd(this, _waitTimeout, (ifTimeout) => {
      setTimeout(() => {
        ifTimeout();
      }, this.type.timeout);
    });
...
var ParserState = (_a5 = class extends Stack {
  constructor(schema2) {
    super();
    __privateAdd(this, _marks, Mark.none);
    __privateAdd(this, _hasText, (node2) => node2.isText);
    __privateAdd(this, _maybeMerge, (a, b) => {
    ...
    __privateAdd(this, _matchTarget, (node2) => {
    ...
    __privateAdd(this, _runNode, (node2) => {
    ...
    __privateAdd(this, _addNodeAndPush, (nodeType, attrs, content3) => {
    ...
    this.openMark = (markType, attrs) => {
      __privateSet(this, _marks, markType.create(attrs).addToSet(__privateGet(this, _marks)));
      return this;
    };
...
}, _marks = new WeakMap(), _hasText = new WeakMap(), _maybeMerge = new WeakMap(), _matchTarget = new WeakMap(), _runNode = new WeakMap(), _closeNodeAndPush = new WeakMap(), _addNodeAndPush = new WeakMap(), _a5.create = (schema2, remark) => {
  const state = new _a5(schema2);
  return (text4) => {
...
var _marks2, _matchTarget2, _runProseNode, _runProseMark, _runNode2, _searchType, _maybeMergeChildren, _createMarkdownNode, _moveSpaces, _closeNodeAndPush2, _addNodeAndPush2, _openMark, _closeMark, _a7;
var SerializerState = (_a7 = class extends Stack {
  constructor(schema2) {
    super();
    __privateAdd(this, _marks2, Mark.none);
    __privateAdd(this, _matchTarget2, (node2) => {
      const result = Object.values({
        ...this.schema.nodes,
        ...this.schema.marks
      }).find((x) => {
    ...
    __privateAdd(this, _runProseNode, (node2) => {
      return __privateGet(this, _matchTarget2).call(this, node2).spec.toMarkdown.runner(this, node2);
    });
    __privateAdd(this, _runProseMark, (mark, node2) => {
      return __privateGet(this, _matchTarget2).call(this, mark).spec.toMarkdown.runner(this, mark, node2);
    });
    __privateAdd(this, _runNode2, (node2) => {
      const { marks } = node2;
      const getPriority = (x) => x.type.spec.priority ?? 50;
      if ([...marks].sort((a, b) => getPriority(a) - getPriority(b)).every((mark) => !__privateGet(this, _runProseMark).call(this, mark, node2))) __privateGet(this, _runProseNode).call(this, node2);
      marks.forEach((mark) => __privateGet(this, _closeMark).call(this, mark));
    });
    __privateAdd(this, _searchType, (child, type) => {
      var _a11;
      if (child.type === type) return child;
      if (((_a11 = child.children) == null ? void 0 : _a11.length) !== 1) return child;
      const searchNode = (node3) => {
        var _a12;
        if (node3.type === type) return node3.value != null ? null : node3;
        if (((_a12 = node3.children) == null ? void 0 : _a12.length) !== 1) return null;
    ...
    __privateAdd(this, _maybeMergeChildren, (node2) => {
    ...
    __privateAdd(this, _createMarkdownNode, (element2) => {
      const node2 = {
        ...element2.props,
        type: element2.type
      };
    ...
    __privateAdd(this, _moveSpaces, (element2, onPush) => {
      let startSpaces = "";
      let endSpaces = "";
    ...
    __privateAdd(this, _closeNodeAndPush2, (trim = false) => {
      const element2 = this.close();
    ...
    __privateAdd(this, _addNodeAndPush2, (type, children, value, props) => {
    ...
    __privateAdd(this, _openMark, (mark, type, value, props) => {
    ...
    __privateAdd(this, _closeMark, (mark) => {
...
var CommandManager = (_a8 = class {
  constructor() {
    __privateAdd(this, _container3, new Container());
...
function overrideBaseKeymap(keymap3) {
  keymap3.Backspace = chainCommands(undoInputRule, deleteSelection, joinTextblockBackward, selectNodeBackward);
  return keymap3;
}
...
var KeymapManager = (_a9 = class {
  constructor() {
    ...
    this.add = (keymap3) => {
      __privateGet(this, _keymap).push(keymap3);
      return () => {
        __privateSet(this, _keymap, __privateGet(this, _keymap).filter((item) => item !== keymap3));
      };
    };
    ...
    this.build = () => {
      ...
      __privateGet(this, _keymap).forEach((item) => {
        keymap3[item.key] = [...keymap3[item.key] || [], item];
      });
      return Object.fromEntries(Object.entries(keymap3).map(([key2, items]) => {
...
var editorState = (ctx) => {
  ...
  return async () => {
    ...
    const doc4 = getDoc(ctx.get(defaultValueCtx), parser2, schema2);
...
var Editor = (_a10 = class {
  constructor() {
    __privateAdd(this, _enableInspector, false);
    __privateAdd(this, _status2, EditorStatus.Idle);
    __privateAdd(this, _configureList, []);
    __privateAdd(this, _onStatusChange, () => void 0);
    __privateAdd(this, _container4, new Container());
    __privateAdd(this, _clock3, new Clock());
    __privateAdd(this, _usrPluginStore, /* @__PURE__ */ new Map());
    __privateAdd(this, _sysPluginStore, /* @__PURE__ */ new Map());
    __privateAdd(this, _ctx3, new Ctx(__privateGet(this, _container4), __privateGet(this, _clock3)));
    ...
    __privateAdd(this, _prepare, (plugins, store) => {
      plugins.forEach((plugin) => {
    ...
    __privateAdd(this, _cleanup, (plugins, remove = false) => {
    ...
    __privateAdd(this, _cleanupInternal, async () => {
    ...
    this.use = (plugins) => {
      ...
      if (__privateGet(this, _status2) === EditorStatus.Created) __privateGet(this, _prepare).call(this, _plugins, __privateGet(this, _usrPluginStore));
      return this;
    };
    this.remove = async (plugins) => {
      if (__privateGet(this, _status2) === EditorStatus.OnCreate) {
    ...
    this.create = async () => {
      if (__privateGet(this, _status2) === EditorStatus.OnCreate) return this;
      if (__privateGet(this, _status2) === EditorStatus.Created) await this.destroy();
    ...
    this.destroy = async (clearPlugins = false) => {
      if (__privateGet(this, _status2) === EditorStatus.Destroyed || __privateGet(this, _status2) === EditorStatus.OnDestroy) return this;
      if (__privateGet(this, _status2) === EditorStatus.OnCreate) return new Promise((resolve) => {
        setTimeout(() => {
...
//# sourceMappingURL=chunk-CVWOTMRC.js.map
